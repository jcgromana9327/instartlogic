...
*/    }
    ...
    public function validateCatalogService()
    {
        ...
        $urlMain = "http://www.partstrain.com/";
        //&format=printr
        $urlArr = array(
            ...
            array(
                "url" => $urlMain . "store/?N=0&src=search&Ntt=mirror",
                "pageType" => "Search Engine Result Page"
            ),
            array(
                "url" => $urlMain . "/store/parts.php?year=4294946109&make=4294958829&model=4294946521&submodel=4294967027&engine=4294962042&widgetloc=JTJGaW5kZXgucGhw&src=vlb",
                "pageType" => "Vehicle Landing Page"
            ),
            array(
                "url" => $urlMain . "Shopby/Make",
                "pageType" => "SEO - Shop by Make"
            ),
            array(
                "url" => $urlMain . "ShopbyBrand/",
                "pageType" => "SEO - Shop by Brand"
            ),
            array(
                "url" => $urlMain . "Shopby/Department",
                "pageType" => "SEO - Shop by Department"
            ),
